		...
		<main className="flex-grow flex-col items-center justify-center p-4 space-y-8 max-w-4xl mx-auto">
			...
			<div className="text-center space-y-4">
				<h1 className="text-3xl md:text-4xl font-bold text-gray-800 max-w-2xl mx-auto">
					¿Necesitas saber si el vehículo que comprarás está en buen
					estado?
				</h1>
				<p className="text-xl md:text-2xl text-purple-600 font-semibold">
					Uno de nuestros mecánicos te ayudará
				</p>
				<div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
					<button
						className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-6 rounded"
						onClick={BuscarMecanicoClick}
					>
						Buscar Mecánico
					</button>
					<button
						className="border-purple-600 text-purple-600 hover:bg-purple-100 font-bold py-2 px-6 rounded"
						onClick={LoginClick}
					>
						Soy Mecánico
					</button>
