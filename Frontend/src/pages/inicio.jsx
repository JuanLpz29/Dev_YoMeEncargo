  ...
  return (
    <main className="flex flex-col items-center justify-center p-4 space-y-8 max-w-4xl mx-auto">
      <div className="w-full h-48 relative rounded-lg overflow-hidden">
        <img src="/placeholder.svg" alt="Decorative top image" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      ...
      <div className="w-full h-48 relative rounded-lg overflow-hidden">
        <img src="/placeholder.svg" alt="Decorative bottom image" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
    </main>
  );
}
