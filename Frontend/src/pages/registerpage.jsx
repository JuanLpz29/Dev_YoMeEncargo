						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div>
								<input
									...
									className={`w-full px-4 py-2 bg-gray-50 border rounded-md text-gray-900 focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
										errors.firstName
											? "border-red-500"
											: "border-gray-300"
									}`}
						...
						<div className="flex items-start">
							<div className="flex items-center h-5">
								<input
									...
									onChange={handleChange}
									className="w-4 h-4 border-2 border-purple-600 rounded bg-gray-50 text-purple-600 focus:ring-purple-500 checked:bg-purple-600"
								/>
							</div>
